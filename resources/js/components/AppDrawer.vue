<template>
    <v-navigation-drawer
        ...
        <vue-perfect-scrollbar class="drawer-menu--scroll" :settings="scrollSettings">
            <v-list dense expand>
                <template v-for="(item, i) in menus" v-if="$auth.check(item.role)")>
                    <!--group with subitens-->
                    <v-list-group v-if="item.itens && $auth.check(item.role)" :key="item.name" :group="item.group" :prepend-icon="item.icon" no-action="no-action">
