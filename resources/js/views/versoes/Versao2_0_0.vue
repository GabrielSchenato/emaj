            ...
            alteracoesPortal() {
                return [
                    ...
                    },
                    {
                        icon: 'fiber_manual_record',
                        color: 'black',
                        text: 'Adaptação (Cadastro): Aplicada melhoria no cadastro do "Cliente" na "Protocolos", agora possui uma nova ação que permite imprimir a ficha de triagem do cliente'
                    },
                    {
                        icon: 'fiber_manual_record',
                        color: 'black',
