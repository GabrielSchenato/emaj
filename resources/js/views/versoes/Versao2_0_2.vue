<template>
    <v-card class="card--flex-toolbar">
        <v-toolbar card prominent>
            <v-toolbar-title class="body-6 black--text">v2.0.2</v-toolbar-title>
            <v-toolbar-title class="body-1 grey--text"><small>13 de Setembro de 2019</small></v-toolbar-title>                      
            <v-spacer></v-spacer>
        </v-toolbar>
        <v-divider></v-divider>
        <v-card-text>
                ...
                return [
                    {
                        ...
                        color: 'black',
                        text: 'Adaptação (Cadastro): Aplicada melhoria na impressão da "Ficha de Triagem", aumentando dessa forma o tamanho do campo "Data" para facilitar a escrita dos professores'
                    }
                ];
            },
